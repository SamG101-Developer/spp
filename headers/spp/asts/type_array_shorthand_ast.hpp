...
struct spp::asts::TypeArrayShorthandAst final : Ast, mixins::TempTypeAst {
     ...
     * @param tok_comma The @code ,@endcode token that separates the element type from the size.
