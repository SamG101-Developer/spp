...
protected:
    ...
    virtual auto equals_boolean_literal(BooleanLiteralAst const &) const -> std::strong_ordering;
    virtual auto equals_float_literal(FloatLiteralAst const &) const -> std::strong_ordering;
    virtual auto equals_identifier(IdentifierAst const &) const -> std::strong_ordering;
    virtual auto equals_integer_literal(IntegerLiteralAst const &) const -> std::strong_ordering;
    virtual auto equals_string_literal(StringLiteralAst const &) const -> std::strong_ordering;
    virtual auto equals_tuple_literal(TupleLiteralAst const &) const -> std::strong_ordering;
    virtual auto equals_type_identifier(TypeIdentifierAst const &) const -> std::strong_ordering;
    virtual auto equals_type_unary_expression(TypeUnaryExpressionAst const &) const -> std::strong_ordering;
    virtual auto equals_type_postfix_expression(TypePostfixExpressionAst const &) const -> std::strong_ordering;
    virtual auto equals(ExpressionAst const &other) const -> std::strong_ordering;
