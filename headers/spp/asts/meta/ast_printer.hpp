...
#define SPP_PRINT_EXTEND(x) formatted_string += x | genex::views::transform([&](auto &&x) { return x->print(printer); }) | genex::views::intersperse(std::string(", ")) | genex::views::flatten | genex::views::to<std::string>();
...
#define SPP_STRING_EXTEND(x) raw_string += x | genex::views::transform([&](auto &&x) { return static_cast<std::string>(*x); }) | genex::views::intersperse(std::string(", ")) | genex::views::flatten | genex::views::to<std::string>();
