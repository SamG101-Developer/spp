...
public:
    ...
    auto parse_closure_expression_parameter_group() -> std::unique_ptr<asts::FunctionParameterGroupAst>;
    auto parse_closure_expression_parameter() -> std::unique_ptr<asts::FunctionParameterAst>;
