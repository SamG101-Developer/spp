...
namespace spp::analyse::utils::bin_utils {
     ...
     */
    SPP_EXP const static auto BIN_OP_PRECEDENCE = std::map<lex::SppTokenType, std::uint8_t>{
     ...
     * to function calls.
     */
    SPP_EXP const static auto BIN_METHODS = std::map<lex::SppTokenType, std::string>{
     ...
     */
    SPP_EXP constexpr static auto BIN_COMPOUND_ASSIGNMENT_OPS = std::array{
     ...
     */
    SPP_EXP constexpr static auto BIN_COMPARISON_OPS = std::array{
