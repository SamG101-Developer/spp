...
/**
 * Lowering for variant types: reading and writing the discriminant, and getting a value into the shape a variant slot
 * expects. Split out of @c spp.codegen.llvm_type , which is about lowering types rather than about the one type whose
 * values need converting on the way in.
 */
