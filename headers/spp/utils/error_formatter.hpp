...
public:
    ...
    auto error_raw_pos(std::size_t ast_start_port, std::size_t ast_size, std::string &&message, std::string &&tag_message) -> std::string;
    auto error(const asts::Ast *ast, std::string &&message, std::string &&tag_message) -> std::string;
