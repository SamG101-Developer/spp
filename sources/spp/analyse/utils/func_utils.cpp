...
auto spp::analyse::utils::func_utils::infer_generic_args(
    ...
    std::map<std::shared_ptr<asts::IdentifierAst>, std::shared_ptr<asts::TypeAst>, DerefCmp> const &infer_source,
    std::map<std::shared_ptr<asts::IdentifierAst>, std::shared_ptr<asts::TypeAst>, DerefCmp> const &infer_target,
