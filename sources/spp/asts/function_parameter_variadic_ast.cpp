...
spp::asts::FunctionParameterVariadicAst::operator icu::UnicodeString() const {
    SPP_STRING_START;
...
auto spp::asts::FunctionParameterVariadicAst::print(meta::AstPrinter &printer) const -> icu::UnicodeString {
    SPP_PRINT_START;
