...
ClassImplementationAst::~ClassImplementationAst() = default;

auto ClassImplementationAst::Clone() const -> Unique<Ast> {
...
auto ClassImplementationAst::Stage6_PreAnalyseSemantics(
  ...
  // Ensure there are no duplicate member names. This needs
  // to be done before semantic analysis as other ASTs might
  // try reading a duplicate attribute before an error is
  // raised.
