...
auto spp::asts::generate::common_types::try_type(std::size_t pos, std::shared_ptr<TypeAst> output_type, std::shared_ptr<TypeAst> residual_type) -> std::unique_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
