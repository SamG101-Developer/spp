...
auto spp::asts::common_types::f8(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::f16(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::f32(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::f64(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::f128(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s8(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s16(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s32(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s64(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s128(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::s256(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::ssize(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u8(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u16(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u32(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u64(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u128(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::u256(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::usize(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::void_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::boolean_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::string_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::string_view_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::never_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::copy_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::array_type(std::size_t pos, std::shared_ptr<TypeAst> elem_type, std::unique_ptr<ExpressionAst> &&size) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::variant_type(std::size_t pos, std::vector<std::shared_ptr<TypeAst>> &&inner_types) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::tuple_type(std::size_t pos, std::vector<std::shared_ptr<TypeAst>> &&inner_types) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(inner_types.size());
    for (auto &&[i, inner_type] : inner_types | genex::views::enumerate) {
        generics_lst[i] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    }
...
auto spp::asts::common_types::try_type(std::size_t pos, std::shared_ptr<TypeAst> output_type, std::shared_ptr<TypeAst> residual_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(output_type));
    generics_lst[1] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(residual_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);

    std::unique_ptr<TypeAst> type = std::make_unique<TypeIdentifierAst>(pos, std::string("Try"), std::move(generics));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("try")), nullptr), std::move(type));
...
auto spp::asts::common_types::future_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::option_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);

    std::unique_ptr<TypeAst> type = std::make_unique<TypeIdentifierAst>(pos, std::string("Opt"), std::move(generics));
...
auto spp::asts::common_types::memory_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::single_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::some_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::none_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
...
auto spp::asts::common_types::gen_type(std::size_t pos, std::shared_ptr<TypeAst> yield_type, std::shared_ptr<TypeAst> send_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
...
auto spp::asts::common_types::gen_once_type(std::size_t pos, std::shared_ptr<TypeAst> yield_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(yield_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::index_mut_type(std::size_t pos, std::shared_ptr<TypeAst> elem_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(elem_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);

    std::unique_ptr<TypeAst> type = std::make_unique<TypeIdentifierAst>(pos, std::string("IndexMut"), std::move(generics));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("idx")), nullptr), std::move(type));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("ops")), nullptr), std::move(type));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("std")), nullptr), std::move(type));
    return type;
}
...
auto spp::asts::common_types::index_ref_type(std::size_t pos, std::shared_ptr<TypeAst> elem_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(elem_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);

    std::unique_ptr<TypeAst> type = std::make_unique<TypeIdentifierAst>(pos, std::string("IndexRef"), std::move(generics));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("idx")), nullptr), std::move(type));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("ops")), nullptr), std::move(type));
    type = std::make_unique<TypeUnaryExpressionAst>(std::make_unique<TypeUnaryExpressionOperatorNamespaceAst>(std::make_unique<IdentifierAst>(pos, std::string("std")), nullptr), std::move(type));
    return type;
...
auto spp::asts::common_types::fun_ref_type(std::size_t pos, std::shared_ptr<TypeAst> param_types, std::shared_ptr<TypeAst> ret_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
...
auto spp::asts::common_types::fun_mut_type(std::size_t pos, std::shared_ptr<TypeAst> param_types, std::shared_ptr<TypeAst> ret_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(param_types));
    generics_lst[1] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(ret_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::fun_mov_type(std::size_t pos, std::shared_ptr<TypeAst> param_types, std::shared_ptr<TypeAst> ret_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(2);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(param_types));
    generics_lst[1] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(ret_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::forward_ref_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::forward_mut_type(std::size_t pos, std::shared_ptr<TypeAst> inner_type) -> std::shared_ptr<TypeAst> {
    auto generics_lst = std::vector<std::unique_ptr<GenericArgumentAst>>(1);
    generics_lst[0] = std::make_unique<GenericArgumentTypePositionalAst>(std::move(inner_type));
    auto generics = std::make_unique<GenericArgumentGroupAst>(nullptr, std::move(generics_lst), nullptr);
...
auto spp::asts::common_types::self_type(std::size_t pos) -> std::shared_ptr<TypeAst> {
