...
[![Tests Passing](https://img.shields.io/badge/Test%20Passing-93.93%25%20(1470/1565)-cactus?logo=pytest&logoColor=ffffff)]()
...
- Package Manager: `git` + `find_package`
- Testing Framework: `GoogleTest (fork) & googletest-parallel`
- Style Guide: `CLion + Google C++ Style Guide (ish)`
- Project Structure: `Modules (split): .ixx/.cpp`
