...
SPP_TEST_SHOULD_FAIL_SEMANTIC(
    IntegerLiteralAst,
    test_invalid_ssize_lower_bound,
    SppIntegerOutOfBoundsError, R"(
    fun f() -> Void {
        let x = -9223372036854775809_sz
    }
)");
...
SPP_TEST_SHOULD_FAIL_SEMANTIC(
    IntegerLiteralAst,
    test_invalid_ssize_upper_bound,
    SppIntegerOutOfBoundsError, R"(
    fun f() -> Void {
        let x = 9223372036854775808_sz
    }
)");
#elif OS_BITS == 32
SPP_TEST_SHOULD_FAIL_SEMANTIC(
...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    IntegerLiteralAst,
    test_valid_positive_no_suffix, R"(
    fun f() -> Void {
        let x = 100
    }
)");
...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    IntegerLiteralAst,
    test_valid_negative_no_suffix, R"(
    fun f() -> Void {
        let x = -100
    }
)");
