...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    FunctionParameterOptionalAst,
    test_valid_function_parameter_optional_non_copyable_default,
    R"(
...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    FunctionParameterOptionalAst,
    test_valid_function_parameter_optional_expression_default,
    R"(
...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    FunctionParameterOptionalAst,
    test_valid_function_parameter_optional_variant_default,
    R"(
...
SPP_TEST_SHOULD_PASS_SEMANTIC(
    FunctionParameterOptionalAst,
    test_valid_function_parameter_optional_omitted_at_call_site,
    R"(
